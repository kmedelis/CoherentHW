...
organization.VacationAdd("mr.", new DateTime(2021, 1, 1), new DateTime(2021, 3, 31));
...
organization.VacationAdd("test", new DateTime(2021, 1, 1), new DateTime(2021, 01, 10));
organization.VacationAdd("test", new DateTime(2021, 1, 1), new DateTime(2021, 01, 02));

Console.WriteLine(organization.CheckForDupliaces()); // returns true because the aboe two overlap
